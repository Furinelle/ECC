...
origin: ECC
hermes_adapter: true
source: ".agents/skills/everything-claude-code"
original_name: "everything-claude-code"
---
> Hermes adapter: This ECC skill is packaged for Hermes Agent. When the original text names Claude Code, Codex, OpenCode, or another harness-specific tool, use the equivalent Hermes terminal, file, search, patch, browser, approval, and delegation tools available in the current session.
